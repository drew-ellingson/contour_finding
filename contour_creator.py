    ...
    for x_pix in range(0, x_size):  # handling image corners and edges
        ...
        for y_pix in range(0, y_size):
            if y_pix == 0:
                ...
                output_img[x_pix, y_pix] = convolution_zoom_in(
                    input_img[x_pix - 1 : x_pix + 2, y_pix - 1 : y_pix + 2], mask_matrix
                )
    return output_img
